...
var ONEBOOK3D_ADDITIONAL_LANGUAGES = [{
	...
	},
	{
		...
		zoom:'Ampliar',
		slope:'Inclinar',
		fromfullscreen:'Salir pantalla completa',
		tofullscreen:'Abrir pantalla completa',
		close:'Cerrar',
		left:'Izquierda',
		right:'Derecha',
		toStart:'Al principio',
		toEnd:'Al final',
		goToHomelink:'Ir a la página principal',
		clickToOpen:'Pulsa para abrir',
		useMousewheel:'Usa la rueda del ratón',
		forEasyViewing:'Para visualizar',
		askSaveImage:'Por favor, selecciona la página a guardar',
		or:'o'
	},
	{
		lng:'en',
		...
		zoom:'Zoom',
		slope:'Slope',
		fromfullscreen:'Exit full screen',
		tofullscreen:'Open full screen',
		close:'Close',
		left:'Left',
		right:'Right',
		toStart:'To start',
		toEnd:'To end',
		goToHomelink:'Go to main page',
		clickToOpen:'Click to open',
		useMousewheel:'Use mousewheel',
		forEasyViewing:'For easy viewing',
		askSaveImage:'Pleae, select page to save',
		or:'or'
	}];
